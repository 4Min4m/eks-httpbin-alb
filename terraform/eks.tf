...
# Fetch OIDC certificate thumbprint for EKS
...
# Attach AmazonEKSVPCResourceController to the EKS cluster role
...
resource "aws_security_group" "eks_cluster" {
  ...
  ingress {
    ...
    to_port     = 443
    protocol    = "tcp"
    cidr_blocks = [var.vpc_cidr]  # Allow HTTPS from within VPC
  }
  egress {
    from_port   = 0
    to_port     = 0
